...
def transfer_yoffs_pred():
    ...
    train_query = "SELECT team, year, yoffs, yoffs_pred FROM [dbo].[Basketball-Predict-Stats]"
    ...
    with hotstreak_engine.begin() as conn:
        for index, row in train_df.iterrows():
            ...
            conn.execute(
                text("UPDATE [dbo].[Basketball-Stats] SET yoffs = :yoffs, yoffs_pred = :yoffs_pred WHERE team = :team AND year = :year"),
