...
conn = pyodbc.connect('Driver={ODBC Driver 18 for SQL Server};Server=tcp:yoffsornah.database.windows.net,1433;Database=YoffsOrNah-base-MLS;Uid=danny1phantom;Pwd={Popp151565__};Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;')
cursor = conn.cursor()
            ...
            if team in games_played:
                ...
                if table_id == 'stats_squads_standard_for':
                    ...
                    data[team].update({
                        ...
                        'pksave_perc': float(cols[19].text.strip())
                    })
